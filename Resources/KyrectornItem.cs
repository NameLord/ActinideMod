...
namespace ActinideMod.Resources
{
    ...
    public class KyrectornItem : Craftable
    {
        public KyrectornItem() : base(
        classId: "KyrectornItem",
        friendlyName: "Kyrectorn",
        description: "An Alien Material infused with Kyanite and Precursor Tech")
        {}
        ...
        public override string IconFileName => "KyrectornItem.png";
