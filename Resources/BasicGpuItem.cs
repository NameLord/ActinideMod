...
namespace ActinideMod.Resources
{
    ...
    public class BasicGpuItem : Craftable
    {
        public static TechType basicgpu;
        public BasicGpuItem() : base(
        classId: "BasicGpuItem",
        friendlyName: "Basic Gpu",
        description: "A normal Graphics Processing Unit for processing graphical data and rendering textures, Supports DX9")
        {
            OnFinishedPatching += () =>
            {
                basicgpu = TechType;
        ...
        public override string IconFileName => "BasicGpuItem.png";
