...
namespace ActinideMod.Resources
{
    ...
    public class KyaniteShardItem : Craftable
    {
        public KyaniteShardItem() : base(
        classId: "KyaniteShardItem",
        friendlyName: "Kyanite Shard",
        description: "Destroied down in multiple shards of Kyanite")
        {}
        ...
        public override string IconFileName => "KyaniteShardItem.png";
